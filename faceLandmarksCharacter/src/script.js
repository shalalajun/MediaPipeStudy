...
import { FilesetResolver, FaceLandmarker,  HandLandmarker} from '@mediapipe/tasks-vision/vision_bundle.js'
...
function createCameraPlaneMesh(camera, depth, material){
 ...
 let matrixRetargetOptions = {
    decompose: true,  // or false, or you can leave it undefined
    scale: 1.0        // or any other number, or you can leave it undefined
  };
  ...
  const createHandLandmarker = async () => {
    const vision = await FilesetResolver.forVisionTasks(
      "https://cdn.jsdelivr.net/npm/@mediapipe/tasks-vision@0.10.0/wasm"
        ...
        console.log("Finished Loading HandDetection Model.");
    }
